...
class ImageProcessor:
    ...
    @staticmethod
    def which_half_is_bbox_on(config: ConfigParameter, bbox: list, image: Image.Image) -> dict:
        ...
        halfline = ImageProcessor.find_spine_position(config, image_array=image_array)
    ...
    @staticmethod
    def mask_image(image: Image.Image, header_bbox: list, meta: dict, direction: str) -> Image.Image:
